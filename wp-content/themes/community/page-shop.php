				...
				<section class="front-section shop">
					<div class="wrapper">
						<header class="section-header">
							<h1 class="section-title">全国のヨガショップを探す<span class="category-color">SHOP SEARCH</span></h1>
						</header>
						...
						<footer class="section-footer">
							<div class="row">
								<div class="col-pc-4 col-pc-offset-4 col-sp-12">
									<a href="<?php echo get_permalink( get_page_by_path('shop')->ID ); ?>/list/" class="button button-footer">おすすめショップ<small class="category-color">PICK UP</small></a>
								</div>
							</div>
						</footer>
					</div>
				...
				<section class="front-section">
					<div class="wrapper">
						...
						<footer class="section-footer">
							<div class="row">
								<div class="col-pc-4 col-pc-offset-4 col-sp-12">
									<a href="<?php echo get_permalink( get_page_by_path('shop')->ID ); ?>/list/" class="button button-footer">新着ショップ<small class="category-color">LATEST ENTRIES</small></a>
								</div>
							</div>
						</footer>
					</div>
