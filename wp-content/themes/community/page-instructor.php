				...
				<section class="front-section instructor">
					<div class="wrapper">
						<header class="section-header">
							<h1 class="section-title">全国のインストラクターを探す<span class="category-color">instructor SEARCH</span></h1>
						</header>
						...
						<footer class="section-footer">
							<div class="row">
								<div class="col-pc-4 col-pc-offset-4 col-sp-12">
									<a href="<?php echo get_permalink( get_page_by_path('instructor')->ID ); ?>" class="button button-footer">新着インストラクター<small class="category-color">LATEST ENTRIES</small></a>
								</div>
							</div>
						</footer>
					</div>
				...
				<section class="front-section instructor">
					<div class="wrapper">
						...
						<footer class="section-footer">
							<div class="row">
								<div class="col-pc-4 col-pc-offset-4 col-sp-12">
									<a href="<?php echo get_permalink( get_page_by_path('instructor')->ID ); ?>" class="button button-footer">おすすめインストラクター<small class="category-color">PICK UP</small></a>
								</div>
							</div>
						</footer>
					</div>
